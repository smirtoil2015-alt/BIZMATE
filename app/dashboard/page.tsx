...
export default function Dashboard() {
  ...
  return <main className="biz-dashboard">
    <aside className="biz-sidebar">
      ...
      <div className="side-bottom"><a href="/dashboard/settings">⚙ Settings</a><a href="/dashboard/knowledge">❔ Academy & Help</a><small>{ownerName} · Authenticated</small><small>Created by MAHMUD ELATVIL</small></div>
    </aside>
    <section className="biz-content">
      <header className="biz-header"><div><small>{companyName} / {active}</small><h1>{active}</h1></div><div className="header-actions"><input placeholder="Search your company..."/><button aria-label="Ask BIZMATE" onClick={() => setAssistant(true)}>✦</button><div className="avatar">{ownerName.slice(0, 2).toUpperCase()}</div></div></header>
